...
for d_name in dir_names:
    if len(d_name) == 1:
        continue
    if d_name[1] == "Bulk every 2d_uncertain_input" and d_name[0] not in deci2d_ipt:
        deci2d_ipt.append(d_name[0])
    if d_name[1] == "Bulk every 4d_uncertain_input" and d_name[0] not in deci4d_ipt:
        deci4d_ipt.append(d_name[0])
    if d_name[1] == "Bulk every 7d_uncertain_input" and d_name[0] not in deci7d_ipt:
        deci7d_ipt.append(d_name[0])
    if d_name[1] == "Bulk every 2d_uncertain_output" and d_name[0] not in deci2d_opt:
        deci2d_opt.append(d_name[0])
    if d_name[1] == "Bulk every 4d_uncertain_output" and d_name[0] not in deci4d_opt:
        deci4d_opt.append(d_name[0])
    if d_name[1] == "Bulk every 7d_uncertain_output" and d_name[0] not in deci7d_opt:
        deci7d_opt.append(d_name[0])
    if d_name[1] == "Bulk every 2d_uncertain_both" and d_name[0] not in deci2d_both:
        deci2d_both.append(d_name[0])
    if d_name[1] == "Bulk every 4d_uncertain_both" and d_name[0] not in deci4d_both:
        deci4d_both.append(d_name[0])
    if d_name[1] == "Bulk every 7d_uncertain_both" and d_name[0] not in deci7d_both:
