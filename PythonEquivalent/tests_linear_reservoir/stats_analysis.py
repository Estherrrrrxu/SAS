...
ax[1].legend(frameon=False, title="Input st.dev", fontsize=12, loc = "upper left")
...
ax[0].set_title("Input RMSE - theoretical input RMSE", fontsize = 15)
ax[1].set_title("Output RMSE - theoretical output RMSE", fontsize = 15)
ax[1].legend(frameon=False, title="Signal to Noise", fontsize=12, loc = "upper left")
plt.rcParams['legend.title_fontsize'] = 'larger'
fig.tight_layout()
# %%
...
ax[0].set_title("Input RMSE - theoretical input RMSE", fontsize = 15)
ax[1].set_title("Output RMSE - theoretical output RMSE", fontsize = 15)
ax[1].legend(frameon=False, title="Threshold", fontsize=12, loc = "upper left")
plt.rcParams['legend.title_fontsize'] = 'larger'
fig.tight_layout()
