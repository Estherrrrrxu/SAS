function [X,ess,theta] = pgas_stateParNodes(pmcmcPar,obs,obsPar,femPar,prior,progressON)
...
[particles,w] =  pf_NodesIPF(obs,obsPar,femPar,pmcmcPar,theta0);
...
for k = 2:numMCMC
    ...
    if strcmp(pmcmcPar.sampler, 'IPF')
        [particles,w,~] = cpf_asNodes_IPF(obs,obsPar,femPar,pmcmcPar,theta0,X(:,:,1));
    else
