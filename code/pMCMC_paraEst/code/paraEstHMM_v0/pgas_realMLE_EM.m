function [X,theta,svar,ess] = pgas_realMLE_EM(numMCMC, obs, Np, ssmPar)
% Runs the PGAS algorithm, SIR in the SMC, EM algorith to estimate the parameter
...
X(1,:) = X1;       ess(1,:) = ess1; 
[thetaEst,varV]  = samplePar_MLE(X1,V1,T1,ft,ssmPar); 
